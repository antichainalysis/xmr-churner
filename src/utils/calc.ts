/**
 * Calculate a random range for the total balance
 * @param {number} totalBalance - The total balance.
 * @returns {[number, number]} - Returns array with minimum and maximum range.
 */
